define("echarts/chart/map", ["require", "./base", "zrender/shape/Text", "zrender/shape/Path", "zrender/shape/Circle", "zrender/shape/Rectangle", "zrender/shape/Line", "zrender/shape/Polygon", "zrender/shape/Ellipse", "../component/dataRange", "../component/roamController", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/event", "../util/mapData/params", "../util/mapData/textFixed", "../util/mapData/geoCoord", "../util/projection/svg", "../util/projection/normal", "../chart"], function(e) {
    ...
    return t.prototype = {
        ...
        _getSubMapData: function(e, t) {
            for (var n = e.replace(/^.*\|/, ""), i = t.features, a = 0, o = i.length; o > a; a++)
                if (i[a].properties && i[a].properties.name == n) {
                    i = i[a], "United States of America" == n && i.geometry.coordinates.length > 1 && (i = {
                        geometry: {
        ...
        _getProjectionData: function(e, t, n) {
            ...
            i.left != l.left || i.top != l.top || i.scale.x != l.scale.x || i.scale.y != l.scale.y ? (s = a.geoJson2Path(t, i, this._specialArea[e]), l = U.clone(i)) : (i = this._mapDataMap[e].transform, s = this._mapDataMap[e].pathArray), this._mapDataMap[e].bbox = r, this._mapDataMap[e].transform = i, this._mapDataMap[e].lastTransform = l, this._mapDataMap[e].pathArray = s;
        ...
        _getSingleProvince: function(e, t, n) {
            ...
            if (y[a]) i = this.geo2pos(e, y[a]);
                ...
                i = this.geo2pos(e, [r.left + r.width / 2, r.top + r.height / 2]), i[0] += o[0], i[1] += o[1]
            }
            return t.name = this._nameChange(e, a), t.position = n, t.textX = i[0], t.textY = i[1], t
        },
        _getTransform: function(e, t, n) {
            ...
            for (var p in t) i = m[p].mapLocation || {}, o = i.x || o, s = i.y || s, l = i.width || l, h = i.height || h;
        ...
        _buildMap: function(e, t, n, d) {
            for (var p, c, u, y, g, b, f, k, x, _, L, W = this.series, X = this.component.legend, K = this.component.dataRange, w = 0, v = t.length; v > w; w++) {
                if (k = U.clone(t[w]), x = {
                        name: k.name,
                        path: k.path,
        ...
        _buildMark: function(e, t) {
            ...
            "none" == e && (n = [0, 0]);
            for (var i in t) this._seriesIndexToMapType[i] = e, this.markAttachStyle[i] = {
                position: n,
                _mapType: e
            }, this.buildMark(i)
        },
        ...
        _findMapTypeByPos: function(e, t) {
            ...
            for (var s in this._mapDataMap)
                if (n = this._mapDataMap[s].transform, n && this._roamMap[s] && this._activeMapType[s] && (i = n.left, a = n.top, o = n.width, r = n.height, e >= i && i + o >= e && t >= a && a + r >= t)) return s
        },
            ...
            if (!(this.shapeList.length <= 0)) {
                ...
                if (!t || !t.draggable) {
                    ...
                    if (o && this._roamMap[o] && "scale" != this._roamMap[o]) {
                        this._mousedown = !0, this._mx = i, this._my = a, this._curMapType = o, this.zr.on(d.EVENT.MOUSEUP, this._onmouseup);
                        var r = this;
                        setTimeout(function() {
        ...
        __onmousemove: function(e) {
            if (this._mousedown && this._isAlive) {
                ...
                a.hasRoam = !0, a.left -= this._mx - n, a.top -= this._my - i, this._mx = n, this._my = i, this._mapDataMap[this._curMapType].transform = a;
        ...
        __onmouseup: function(e) {
            ...
            var n = this;
            setTimeout(function() {
                n._justMove && n.animationEffect(), n._justMove = !1, n.zr.un(d.EVENT.MOUSEMOVE, n._onmousemove), n.zr.un(d.EVENT.MOUSEUP, n._onmouseup)
            }, 120)
        },
        ...
        __ondrhoverlink: function(e) {
            for (var t, n, i = 0, a = this.shapeList.length; a > i; i++) t = this.shapeList[i]._mapType, this._hoverLinkMap[t] && this._activeMapType[t] && (n = V.get(this.shapeList[i], "value"), null != n && n >= e.valueMin && n <= e.valueMax && this.zr.addHoverShape(this.shapeList[i]))
        },
        onclick: function(e) {
    ...
    return s.prototype = {
        ...
        buildPathArray: function(e, t, n) {
            ...
            for (r = 1; r < s.length; r++) {
                ...
                for (; d.length > 0 && !isNaN(d[0]);) {
                    ...
                    for (var K = 0, w = L.length; w > K; K += 2) L[K] += t, L[K + 1] += n;
                    l.push(new i(_ || U, L))
        ...
        getRect: function(e) {
            ...
            for (var n = Number.MAX_VALUE, i = Number.MIN_VALUE, a = Number.MAX_VALUE, o = Number.MIN_VALUE, r = e.x || 0, s = e.y || 0, l = e.pathArray || this.buildPathArray(e.path), h = 0; h < l.length; h++)
                for (var m = l[h].points, V = 0; V < m.length; V++) V % 2 === 0 ? (m[V] + r < n && (n = m[V]), m[V] + r > i && (i = m[V])) : (m[V] + s < a && (a = m[V]), m[V] + s > o && (o = m[V]));
            var U;
    ...
    return n.prototype = {
        ...
        buildPath: function(e, t) {
            var n = .5522848,
                ...
                s = o * n,
                l = r * n;
            e.moveTo(i - o, a), e.bezierCurveTo(i - o, a - l, i - s, a - r, i, a - r), e.bezierCurveTo(i + s, a - r, i + o, a - l, i + o, a), e.bezierCurveTo(i + o, a + l, i + s, a + r, i, a + r), e.bezierCurveTo(i - s, a + r, i - o, a + l, i - o, a), e.closePath()
        },
        getRect: function(e) {
            if (e.__rect) return e.__rect;
            var t;
    ...
    return t.prototype = {
        ...
        _buildItem: function() {
            ...
            for (var y = 0; s > y; y++) e = r[y], o = this.getColorByIndex(y), t = this._getItemShape(m, V, U, d, this._selectedMap[y] ? o : "#ccc"), t._idx = y, t.onmousemove = this._dispatchHoverLink, this.dataRangeOption.selectedMode && (t.clickable = !0, t.onclick = this._dataRangeSelected), this.shapeList.push(new a(t)), u && (n = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
                    x: m + U + 5,
            ...
            }, "vertical" == this.dataRangeOption.orient && "right" == this.dataRangeOption.x && (n.style.x -= U + 10, n.style.textAlign = "right"), n._idx = y, n.onmousemove = this._dispatchHoverLink, this.dataRangeOption.selectedMode && (n.clickable = !0, n.onclick = this._dataRangeSelected), this.shapeList.push(new i(n))), "horizontal" == this.dataRangeOption.orient ? m += U + (u ? 5 : 0) + (u ? h.getTextWidth(e, l) : 0) + p : V += d + p;
            !u && this.dataRangeOption.text[1] && ("horizontal" == this.dataRangeOption.orient ? m = m - p + this._textGap : V = V - p + this._textGap, n = this._getTextShape(m, V, this.dataRangeOption.text[1]), "horizontal" != this.dataRangeOption.orient && (n.style.y -= 5, n.style.textBaseline = "top"), this.shapeList.push(new i(n)))
        },
        _buildGradient: function() {
            ...
            "horizontal" == this.dataRangeOption.orient ? (t = {
                ...
                hoverable: !1
            }, s += m * U + this._textGap), this.shapeList.push(new a(t)), this._calculableLocation = t.style, this.dataRangeOption.calculable && (this._buildFiller(), this._bulidMask(), this._bulidHandle()), this._buildIndicator(), !d && this.dataRangeOption.text[1] && (n = this._getTextShape(r, s, this.dataRangeOption.text[1]), this.shapeList.push(new i(n)))
        },
        ...
        _getItemGroupLocation: function() {
            ...
            if ("horizontal" == this.dataRangeOption.orient) {
                ...
                var U;
                if (this.dataRangeOption.text || this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable) r = (this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable ? a * m + n : t * (a + n)) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[0] ? this._textGap + l : 0) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[1] ? this._textGap + l : 0), U = Math.max(h.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[0] || "", s), h.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[1] || "", s)), o = Math.max(i, U);
                else {
                    r = (a + n) * t, i += 5, U = 0;
        ...
        __ondrift: function(e, t, n) {
            var i = this._calculableLocation.x,
                ...
                r = this._calculableLocation.height;
            return "horizontal" == this.dataRangeOption.orient ? e.style.x + t <= i ? e.style.x = i : e.style.x + t + e.style.width >= i + o ? e.style.x = i + o - e.style.width : e.style.x += t : e.style.y + n <= a ? e.style.y = a : e.style.y + n + e.style.height >= a + r ? e.style.y = a + r - e.style.height : e.style.y += n, "filler" == e._type ? this._syncHandleShape() : this._syncFillerShape(e), this.dataRangeOption.realtime && this._dispatchDataRange(), !0
        },
        ...
        __dispatchHoverLink: function(e) {
            ...
            if (this.dataRangeOption.calculable) {
                ...
                i = "horizontal" == this.dataRangeOption.orient ? (1 - (l.getX(e.event) - this._calculableLocation.x) / this._calculableLocation.width) * a : (1 - (l.getY(e.event) - this._calculableLocation.y) / this._calculableLocation.height) * a, t = i - .05 * a, n = i + .05 * a
            } else {
                var o = e.target._idx;
        ...
        refresh: function(e) {
            if (e) {
                ...
                if (this._colorList = m.getGradientColors(this.dataRangeOption.color, Math.max((t - this.dataRangeOption.color.length) / (this.dataRangeOption.color.length - 1), 0) + 1), this._colorList.length > t) {
                    for (var n = this._colorList.length, i = [this._colorList[0]], a = n / (t - 1), o = 1; t - 1 > o; o++) i.push(this._colorList[Math.floor(o * a)]);
                ...
                this.dataRangeOption.precision = r, this._gap = ((this.dataRangeOption.max - this.dataRangeOption.min) / t).toFixed(r) - 0, this._valueTextList = [];
    ...
    function t(e) {
        ...
        for (var t = e.features, i = 0; i < t.length; i++)
            for (var a = t[i], o = a.geometry.coordinates, r = a.geometry.encodeOffsets, s = 0; s < o.length; s++) {
                var l = o[s];
    ...
    function n(e, t) {
        for (var n = [], i = t[0], a = t[1], o = 0; o < e.length; o += 2) {
            ...
            r = r >> 1 ^ -(1 & r), s = s >> 1 ^ -(1 & s), r += i, s += a, i = r, a = s, n.push([r / 1024, s / 1024])
        }
        return n
    }
    var i = {
        ...
        "南海诸岛": {
            ...
            getPath: function(e, t) {
                for (var n = [
                    ...
                    ], i = "", a = e[0], o = e[1], r = 0, s = n.length; s > r; r++) {
                    i += "M " + ((n[r][0][0] * t + a).toFixed(2) - 0) + " " + ((n[r][0][1] * t + o).toFixed(2) - 0) + " ";
                    for (var l = 1, h = n[r].length; h > l; l++) i += "L " + ((n[r][l][0] * t + a).toFixed(2) - 0) + " " + ((n[r][l][1] * t + o).toFixed(2) - 0) + " "
                }
                return i + " Z"
            }
        },
    ...
    function s(e, t) {
        ...
        n && "none" != n ? (e.color = n, i ? (e.brushType = "both", e.strokeColor = i) : e.brushType = "fill") : i && "none" != i && (e.strokeColor = i, e.brushType = "stroke"), a && "none" != a && (e.lineWidth = parseFloat(a)), o && "none" != o && (e.opacity = parseFloat(o))
    }

    function l(e) {
        for (var t = r(e).replace(/,/g, " ").split(/\s+/), n = [], i = 0; i < t.length;) {
            ...
            polygon: function(e, t) {
                ...
                if (n) {
                    ...
                    for (var o = 0; o < n.length; o++) {
                        var r = n[o];
                        i[0] = Math.min(r[0], i[0]), i[1] = Math.min(r[1], i[1]), a[0] = Math.max(r[0], a[0]), a[1] = Math.max(r[1], a[1])
                    }
                    return {
                        shapeType: "polygon",
                        pointList: n,
    ...
    function t(e, t) {
        ...
        for (var n, i, a = e.features, o = 0, s = a.length; s > o; o++)
            if (i = a[o], !i.properties.name || !t[i.properties.name]) switch (i.type) {
                case "Feature":
    ...
    function n(e, n, i) {
        ...
        i = i || {}, o.scale = null, o.offset = null, e.srcSize || t(e, i), n.offset = {
            x: e.srcSize.left,
            y: e.srcSize.top,
            left: n.OffsetLeft || 0,
            top: n.OffsetTop || 0
        ...
        for (var r, s, l, h = e.features, m = [], V = 0, U = h.length; U > V; V++)
            if (l = h[V], !l.properties.name || !i[l.properties.name])
    ...
    function i(e, t) {
        var n, i;
        return t instanceof Array ? (n = 1 * t[0], i = 1 * t[1]) : (n = 1 * t.x, i = 1 * t.y), n = n / e.scale.x + e.offset.x - 168.5, n = n > 180 ? n - 360 : n, i = 90 - (i / e.scale.y + e.offset.y), [n, i]
    }
    ...
    var o = {
            ...
            LineString: function(e) {
                for (var t, n = "", i = 0, a = e.length; a > i; i++) t = o.makePoint(e[i]), n = 0 === i ? "M" + t.join(",") : n + "L" + t.join(",");
                return n
            },
            Polygon: function(e) {
                for (var t = "", n = 0, i = e.length; i > n; n++) t = t + o.LineString(e[n]) + "z";
                return t
            },
            ...
            MultiLineString: function(e) {
                for (var t = "", n = 0, i = e.length; i > n; n++) t += o.LineString(e[n]);
                return t
            },
            MultiPolygon: function(e) {
                for (var t = "", n = 0, i = e.length; i > n; n++) t += o.Polygon(e[n]);
                return t
            }
        },
        r = {
            ...
            makePoint: function(e) {
                var t = this,
                    ...
                    i = n[0],
                    a = n[1];
                t.xmin > i && (t.xmin = i), t.xmax < i && (t.xmax = i), t.ymin > a && (t.ymin = a), t.ymax < a && (t.ymax = a)
            },
            Point: function(e) {
                this.makePoint(e)
            },
